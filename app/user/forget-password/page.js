...
import { handleSendForget, handlefind } from "@/app/_utils/users_utils";
import hiddenEmail from "@/app/_utils/hiddenEmail";
    ...
    return (
        ...
        >
            {!finding ? (
                ...
                <div
                    className={`mt-20 w-full md:w-1/2 mx-auto ${sending ? "" : "border shadow p-10"
                        } rounded-md bg-white`}
                >
                    {!sending ? (
